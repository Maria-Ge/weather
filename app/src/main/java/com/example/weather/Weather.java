...
public class Weather extends AppCompatActivity  {
    ...
    private void sendRequestWithOkHttp () {
        ...
        Request request = new Request.Builder().get()
                .url("https://restapi.amap.com/v3/weather/weatherInfo?key=8486c9c4560570914af1b347180f5e27&city=" + researchcitycode)//获取地址
                .build();
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                //返回结果处理
                final String responseStr = response.body().string();//提取JASON
    ...
    private void parseJSONWithFastJSON (String jsonData){
        if (jsonData.length() < 100) {
            ...
            tianqi tianqi=JSONObject.parseObject(jsonData, tianqi.class);//修改主活动代码，进行JSON解析
